...
def print_short(res , f):
    ...
    tags = res.get('tags', '')
    ip = res.get('ip', 'N/A')
    protocols = res.get('protocols' , 'N/A')
    ...
    protocols = ', '.join([unicode(p.encode('UTF-8'), errors='ignore') for p in protocols])
...
if __name__ == '__main__':
    ...
    api = dict()
    api['id'] = '558d0b15-07a5-47a4-b68f-b0530181f791'
    api['secret'] = 'YwgekK1zvhvmn2rjRmQPFblsKNIMlFwC'
